...
urlpatterns = [
    ...
    # -----------------------------
    path(
        "polls/<uuid:poll_public_id>/vote/",
        VoteView.as_view(),
        name="poll-vote"
    ),
    ...
    # -----------------------------
    path(
        "polls/<uuid:poll_public_id>/tokens/",
        GenerateVoterTokensView.as_view(),
        name="poll-generate-tokens"
    ),
    ...
    # -----------------------------
    path(
        "polls/<uuid:poll_public_id>/finalize/",
        FinalizePollView.as_view(),
        name="poll-finalize"
    ),
]
